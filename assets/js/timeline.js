jQuery(document).ready(function($){
	...
	function initTimeline(timelines) {
		timelines.each(function(){
			...
			timelineComponents['timelineWrapper'] = timeline.find('.events-wrappers');
			timelineComponents['eventsWrapper'] = timelineComponents['timelineWrapper'].children('.wrap-events');
